...
const Home = () => (
  <div>
    ...
    <div className="home__text">
      <p>This webpage allows people to vote on titles of blogs they find most interesting.</p><br/>
      <p>Vote for the title that seems the most appeasing.</p><br/>
      <p className="home__small-text">Created by Michael Koblinski</p>
